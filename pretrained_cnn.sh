...
#$ -N pretrained_cnn_training  # Updated job name
...
python3 pretrained_cnn.py > /projectnb/dl4ds/students/annliang/job_output_pretrained_cnn.log 2>&1

# Move CSV output to project directory with "_soph_cnn"
mv submission_ood.csv /projectnb/dl4ds/students/annliang/submission_ood_pretrained_cnn.csv
